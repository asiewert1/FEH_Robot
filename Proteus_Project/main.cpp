...
void followLine(){
    ...
    while (CdS_cell.Value() >= 1 && micro_left.Value() && micro_right.Value() && (TimeNow() - t_now < 15)){
...
int main(){
    ...
    // }
        ...
        if(val < 1){
            ...
            turnOnlyLeft(400, percent);
            moveForward(450, percent);
            turnOnlyRight(400, percent);
